...
One last important data structure is a \texttt{Layer} (Appendix~A-8).
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.75\columnwidth]{Figures/agent_actions.png}
...
Here is an \texttt{ElevationModification} that will allow creation of hills and valleys within an environment.
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.725\columnwidth]{Figures/visualization_page.png}
