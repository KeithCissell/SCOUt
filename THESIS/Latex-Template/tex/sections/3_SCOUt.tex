...
\begin{figure}[!htb]
  ...
  \caption{Client-server architecture of SCOUt's framework. The server handles all data storage and manipulation, while the client provides a graphical user interface for requesting and displaying data.}
...
\begin{lstfloat}
  \caption{Definition of \texttt{ElevationSeed} which extends the \texttt{ElementSeed} trait (\ref{appendix:elementseed_trait}). This provides the values and functions used to initialize a layer of elevation values in an environment.}
